...
const Wrapper = styled.div`
  ...
  height: 40px;
  display: grid;
  grid-template-columns: 0.1fr 3fr 1fr 1.8fr 0.1fr;
...
const PollListItem = ({key, date, votes, letters, question}) => (
  <PollListItemContainer>
    <Wrapper>
      <PollLetters>{letters}</PollLetters>
      <Text>{question}</Text>
        <Text><TextInfo> Created</TextInfo><Info>a day ago{date}</Info>
        </Text>
        <Text>
            <TextInfo> Votes</TextInfo><Info>2 users{votes}</Info></Text>
        <IconWrapper><Svg viewBox="0 0 16 16" >
            <path
                fill="#BFCCE0"
            ...
            {/*<Svg/>*/}
            <Svg viewBox="0 0 14 16" width="14">
            <path
                fill="#BFCCE0"
